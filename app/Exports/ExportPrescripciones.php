...
class ExportPrescripciones implements FromView, WithTitle
    ...
    // WithColumnFormatting, WithMapping, WithStyles, WithDrawings //, WithDefaultStyles, FromView
{
    ...
    public function view(): View {
        ...
        return view('exports.reportePrescripcionesEXCEL', [
            'registros' => DB::table('predios_prescripciones')
                            ...
                            ->whereRaw(DB::raw("predios_prescripciones.created_at >= CONVERT(datetime, '" . $this->fechaInicial . " 00:00:00.000')"))
                            ->whereRaw(DB::raw("predios_prescripciones.created_at <= CONVERT(datetime, '" . $this->fechaFinal . " 23:59:59.999')"))

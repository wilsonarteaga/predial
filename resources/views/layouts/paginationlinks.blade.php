@if($paginator->hasPages())
    <ul class="pagination pull-right">
        ...
        @if($paginator->onFirstPage())
            <li class="page-item disabed"><a class="page-link"><span>&laquo;</span></a></li>
        @else
        ...
        @if($paginator->hasMorePages())
            <li class="page-item"><a href="{{ $paginator->nextPageUrl() }}" class="page-link" rel="next"><span>&raquo;</span></a></li>
        @else

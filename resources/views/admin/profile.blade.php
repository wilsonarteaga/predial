...
<div class="container-fluid">
            ...
            <div class="white-box">
                    <div class="row row-in">
                        ...
                        <ul class="col-in">
                                ...
                                <li class="col-last"><h3 class="counter text-right m-t-15">76</h3></li>
                                <li class="col-middle">
        ...
        <div class="col-md-6 col-sm-6 col-lg-3 col-xs-12">
            <div class="bg-theme white-box m-b-0">
                <ul class="expense-box">
                    <li><i class="wi wi-day-cloudy text-white"></i><span><h1 class="text-white m-b-0">35<sup>o</sup></h1><h4 class="text-white">Clear and sunny</h4></span></li>
                </ul>
                                    ...
                                    <table class="table" cellspacing="14">
                                        ...
                                        <tbody>
                                            <tr class="advance-table-row active">
                                                ...
                                                <td width="60"><img src="../theme/plugins//images/users/varun.jpg" class="img-circle" width="30" /></td>
                                                <td>Andrew Simons</td>
                                                <td>Modulator</td>
                                                <td>6 May 2016</td>
                                                <td>Gujrat, India</td>
                                            ...
                                            <tr class="advance-table-row">
                                                ...
                                                <td><img src="../theme/plugins//images/users/genu.jpg" class="img-circle" width="30" /></td>
                                                <td>Hanna Gover</td>
                                                <td>Admin</td>
                                                <td>13 Jan 2005</td>
                                            ...
                                            <tr class="advance-table-row">
                                                ...
                                                <td><img src="../theme/plugins//images/users/sonu.jpg" class="img-circle" width="30" /></td>
                                                <td>Joshi Nirav</td>
                                                <td>Admin</td>
                                                <td>21 Mar 2001</td>
                                            ...
                                            <tr class="advance-table-row">
                                                ...
                                                <td><img src="../theme/plugins//images/users/pawandeep.jpg" class="img-circle" width="30" /></td>
                                                <td>Joshi Sunil</td>
                                                <td>Admin</td>
                                                <td>21 Mar 2004</td>
                                                <td>Gujarat, India</td>
            ...
            <div class="panel wallet-widgets">
                <div class="panel-body">
                    <ul class="side-icon-text">
                        <li class="m-0"><a href="#"><span class="circle circle-md bg-success di vm"><i class="ti-plus"></i></span><span class="di vm"><h1 class="m-b-0">$458.50</h1><h5 class="m-t-0">Your wallet Banalce</h5></span></a></li>
                    </ul>
                </div>
    ...
    <!-- <div class="row">
        <div class="col-md-6 col-sm-12 col-lg-4">
            <div class="panel">
                <div class="p-30">
                    <div class="row">
                        <div class="col-xs-4 col-sm-4"><img src="../theme/plugins//images/users/varun.jpg" alt="varun" class="img-circle img-responsive"></div>
                ...
                <div class="p-20 text-center">
                    ...
                    <ul class="dp-table m-t-30">
                        <li><img src="../theme/plugins//images/users/varun.jpg" alt="varun" width="60" data-toggle="tooltip" title="Varun Dhavan" class="img-circle"></li>
                        <li><img src="../theme/plugins//images/users/genu.jpg" alt="varun" width="60" data-toggle="tooltip" title="Varun Dhavan" class="img-circle"></li>
                        <li><img src="../theme/plugins//images/users/pawandeep.jpg" alt="varun" width="60" data-toggle="tooltip" title="Varun Dhavan" class="img-circle"></li>
                ...
                <div class="panel-footer">
                    <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                        <li class="list-group-item" data-role="task">
                            ...
                            <ul class="assignedto">
                                <li><img src="../theme/plugins//images/users/1.jpg" data-toggle="tooltip" data-placement="top" title="Steave"/></li>
                                <li><img src="../theme/plugins//images/users/2.jpg" data-toggle="tooltip" data-placement="top" title="Jessica"/></li>
                                <li><img src="../theme/plugins//images/users/3.jpg" data-toggle="tooltip" data-placement="top" title="Priyanka"/></li>
                                <li><img src="../theme/plugins//images/users/4.jpg" data-toggle="tooltip" data-placement="top" title="Selina"/></li>
                            </ul>
                        </li>
                        <li class="list-group-item" data-role="task">
                            <div class="checkbox checkbox-info">
                        ...
                        <li class="list-group-item" data-role="task">
                            ...
                            <ul class="assignedto">
                                <li><img src="../theme/plugins//images/users/1.jpg" data-toggle="tooltip" data-placement="top" title="Assign to Steave"/></li>
                                <li><img src="../theme/plugins//images/users/2.jpg" data-toggle="tooltip" data-placement="top" title="Assign to Jessica"/></li>
                                <li><img src="../theme/plugins//images/users/4.jpg" data-toggle="tooltip" data-placement="top" title="Assign to Selina"/></li>
                            </ul>
                        </li>
                    </ul>
                </div>
    ...
    <!-- ============================================================== -->
    <!-- <div class="row">
        <div class="col-md-6 col-lg-3 col-xs-12 col-sm-6"> <img class="img-responsive" alt="user" src="../theme/plugins//images/big/img1.jpg">
            <div class="white-box">
        ...
        <div class="col-md-6 col-lg-3 col-xs-12 col-sm-6"> <img class="img-responsive" alt="user" src="../theme/plugins//images/big/img2.jpg">
            <div class="white-box">
                <div class="text-muted"><span class="m-r-10"><i class="icon-calender"></i> May 16</span> <a class="text-muted m-l-10" href="#"><i class="fa fa-heart-o"></i> 38</a></div>
                <h3 class="m-t-20 m-b-20">Top 20 Models are on the ramp</h3>
                <p>Titudin venenatis ipsum ac feugiat. Vestibulum ullamcorper quam.</p>
        ...
        <div class="col-md-6 col-lg-3 col-xs-12 col-sm-6"> <img class="img-responsive" alt="user" src="../theme/plugins//images/big/img3.jpg">
            <div class="white-box">
                <div class="text-muted"><span class="m-r-10"><i class="icon-calender"></i> May 16</span> <a class="text-muted m-l-10" href="#"><i class="fa fa-heart-o"></i> 38</a></div>
                <h3 class="m-t-20 m-b-20">Top 20 Models are on the ramp</h3>
                <p>Titudin venenatis ipsum ac feugiat. Vestibulum ullamcorper quam.</p>
        ...
        <div class="col-md-6 col-lg-3 col-xs-12 col-sm-6"> <img class="img-responsive" alt="user" src="../theme/plugins//images/big/img4.jpg">
            <div class="white-box">
                <div class="text-muted"><span class="m-r-10"><i class="icon-calender"></i> May 16</span> <a class="text-muted m-l-10" href="#"><i class="fa fa-heart-o"></i> 38</a></div>
                <h3 class="m-t-20 m-b-20">Top 20 Models are on the ramp</h3>
                <p>Titudin venenatis ipsum ac feugiat. Vestibulum ullamcorper quam.</p>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            ...
            <div class="panel panel-themecolor">
                ...
                <div class="panel-body">
                    ...
                    <div class="sl-item">
                        ...
                        <div class="sl-right">
                            ...
                            <div class="row inline-photos">
                                <div class="col-xs-4"><img class="img-responsive" alt="user" src="../theme/plugins//images/small/vd1.jpg"></div>
                                <div class="col-xs-4"><img class="img-responsive" alt="user" src="../theme/plugins//images/small/vd2.jpg"></div>
                                <div class="col-xs-4"><img class="img-responsive" alt="user" src="../theme/plugins//images/small/vd3.jpg"></div>
                            </div>
                        </div>
                    </div>
                    <div class="sl-item">
                        <div class="sl-left"> <img class="img-circle" alt="user" src="../theme/plugins//images/users/sonu.jpg"> </div>
                        <div class="sl-right">
                    ...
                    <div class="sl-item">
                        <div class="sl-left"> <img class="img-circle" alt="user" src="../theme/plugins//images/users/ritesh.jpg"> </div>
                        <div class="sl-right">
                    ...
                    <div class="sl-item">
                        <div class="sl-left"> <img class="img-circle" alt="user" src="../theme/plugins//images/users/govinda.jpg"> </div>
                        <div class="sl-right">

    ...
    <div class="top-left-part">
        ...
        <a class="logo" href="/profile">
            ...
            <span class="hidden-xs">
                ...
                <img src="{!! asset('theme/plugins/images/admin-text.png') !!}" alt="home" class="dark-logo" />
                <!--This is light logo text-->
                <img src="{!! asset('theme/plugins/images/admin-text-dark.png') !!}" alt="home" class="light-logo" />
            </span> </a>
    </div>
    <!-- /Logo -->
            ...
            <ul class="dropdown-menu mailbox animated bounceInDown">
                ...
                <li>
                    <div class="message-center">
                        <a href="#">
                            <div class="user-img"> <img src="{!! asset('theme/plugins/images/users/pawandeep.jpg') !!}" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                            <div class="mail-contnet">
                                <h5>Pavan kumar</h5> <span class="mail-desc">Just see the my admin!</span> <span class="time">9:30 AM</span> </div>
                        </a>
                        <a href="#">
                            <div class="user-img"> <img src="{!! asset('theme/plugins/images/users/sonu.jpg') !!}" alt="user" class="img-circle"> <span class="profile-status busy pull-right"></span> </div>
                            <div class="mail-contnet">
                                <h5>Sonu Nigam</h5> <span class="mail-desc">I've sung a song! See you at</span> <span class="time">9:10 AM</span> </div>
                        </a>
                        <a href="#">
                            <div class="user-img"> <img src="{!! asset('theme/plugins/images/users/arijit.jpg') !!}" alt="user" class="img-circle"> <span class="profile-status away pull-right"></span> </div>
                            <div class="mail-contnet">
                                <h5>Arijit Sinh</h5> <span class="mail-desc">I am a singer!</span> <span class="time">9:08 AM</span> </div>
                        </a>
                        <a href="#">
                            <div class="user-img"> <img src="{!! asset('theme/plugins/images/users/pawandeep.jpg') !!}" alt="user" class="img-circle"> <span class="profile-status offline pull-right"></span> </div>
                            <div class="mail-contnet">
    ...
    <ul class="nav navbar-top-links navbar-right pull-right">
        ...
        <li class="dropdown">
            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#">
                ...
                {{-- <i class="ti-user" style="font-size: 200%;"></i> --}}

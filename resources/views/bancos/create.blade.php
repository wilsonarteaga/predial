...
@push('scripts')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\BancosCreateFormRequest', '#create-form'); !!}
    {!! JsValidator::formRequest('App\Http\Requests\BancosUpdateFormRequest', '#update-form'); !!}
                        ...
                        <div class="content-wrap">
                            <section id="section-bar-1" class="content-current">
                                <div class="panel panel-inverse">
                                    <div class="panel-heading"><i  class="{{ $opcion->icono }}"></i>&nbsp;&nbsp;Informaci&oacute;n del banco</div>
                                    <div class="panel-wrapper collapse in" aria-expanded="true">
                                        <div class="panel-body">
                                            <form action="{{ route('bancos.create_bancos') }}" method="post" id="create-form">
                                                @csrf
                                                <div class="result">
                                                ...
                                                <div class="form-body">
                                                    <!-- <h3 class="box-title">Informaci&oacute;n de la banco</h3> -->
                                                    <!-- <hr> -->
                                                    <div class="row">
                                                        <div class="col-md-3">
                            ...
                            <section id="section-bar-2" class="">
                                        ...
                                        <div class="well">
                                            @if(isset($bancos))
                                                ...
                                                <table id="myTable" class="table table-hover table-striped table-bordered">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="cell_center">Cuenta contable</th>
                                                            <th class="cell_center">Asobancaria</th>
                                                        ...
                                                        @if(count($bancos) > 0)
                                                            ...
                                                            <tr style="cursor: pointer;" json-data='@json($banco)'>
                                                                ...
                                                                <td class="cell_center">
                                                                    <button type="button" ide="{{ $banco->id }}" class="modify_row btn btn-info"><i class="fa fa-pencil-square"></i></button>
                                                                    &nbsp;&nbsp;
                                                                    <button type="button" ide="{{ $banco->id }}" class="delete_row btn btn-inverse"><i class="fa fa-trash-o"></i></button>
                                                                </td>
                                                            </tr>
                                                            @endforeach
                                                        {{-- @else
                                                ...
                                                {{-- <div class="pagination-blobk">
                                                    {{ $bancos->links('layouts.paginationlinks') }}
                                                </div> --}}
                                                <form id="form_delete" action="{{ route('bancos.delete_bancos') }}" method="post" style="display: none;">
                                                    @csrf
                                ...
                                <div id="div_edit_form" class="panel panel-info" style="display: none;">
                                    <div class="panel-heading"><i  class="{{ $opcion->icono }}"></i>&nbsp;&nbsp;Actualizar informaci&oacute;n del banco</div>
                                    <div class="panel-wrapper collapse in" aria-expanded="true">
                                        <div class="panel-body">
                                            <form action="{{ route('bancos.update_bancos') }}" method="post" id="update-form">
                                                @csrf

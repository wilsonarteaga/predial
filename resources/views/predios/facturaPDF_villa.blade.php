            ...
            <table class="table-header">
                <tr>
                    <td style="width: 10%; text-align: left; vertical-align: bottom; border: 0px solid black;">
                        <img class="logo" style="width: 90%; height: auto;" src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('/theme/plugins/images/villa-de-leyva-h.png'))) }}" alt="Logo" />

...
@push('scripts')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\PrediosExoneracionesVigenciaCreateFormRequest', '#create-form'); !!}
    {!! JsValidator::formRequest('App\Http\Requests\PrediosExoneracionesVigenciaUpdateFormRequest', '#update-form'); !!}
                                ...
                                <div class="panel panel-inverse">
                                    ...
                                    <div class="panel-wrapper collapse in" aria-expanded="true">
                                        <div class="panel-body">
                                            ...
                                            @endif
                                            <form action="{{ route('predios.create_exoneraciones') }}" method="post" id="create-form">
                                                @csrf
                                                <div class="result">
                                                ...
                                                <div class="form-actions m-t-20">
                                                    <button id="btn_save_create" type="button" class="btn btn-info" desc="exoneraci&oacute;n de vigencia"> <i class="fa fa-save"></i> Guardar informaci&oacute;n</button>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="well">
                                            @if(isset($predios))
                                                ...
                                                <form id="form_delete" action="{{ route('predios.delete_exoneraciones') }}" method="post" style="display: none;">
                                                    @csrf
                                ...
                                <div id="div_edit_form" class="panel panel-info" style="display: none; margin-bottom: 0px">
                                    ...
                                    <div class="panel-wrapper collapse in" aria-expanded="true">
                                        <div class="panel-body">
                                            ...
                                            @endif
                                            <form action="{{ route('predios.update_exoneraciones') }}" method="post" id="update-form">
                                                @csrf
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                            <div class="form-group">
                                                                <label class="control-label">C&oacute;digo predio:</label>
                                                                <input type="hidden" id="id_predio_edit" name="id_predio_edit" value="{{ old('codigo_predio_edit') }}">

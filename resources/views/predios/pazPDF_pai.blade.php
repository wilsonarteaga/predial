            ...
            <table class="info-validez" style="width: 100%; margin-top: 50px;">
                <tr>
                    ...
                    <td style="text-align: center;">
                        <img style="position: absolute; top: -30px; width: 20%; height: auto; margin-left: 100px;" src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('/theme/plugins/images/firma-paz-y-salvo-paipa-3.png'))) }}" alt="Firma" />

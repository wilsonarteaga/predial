            ...
            <div class="white-box">
                <section>
                    <div class="sttabs tabs-style-bar">
                        <nav>
                            <ul>
                                <li id="li-section-bar-1" class="tab-current"><a href="#section-bar-1" class="sticon ti-control-shuffle"><span>Nuevo tipo de predio</span></a></li>
                                                    ...
                                                    <tbody>
                                                        @if(count($tipos_predio) > 0)
                                                            ...
                                                            <tr style="cursor: pointer;" json-data='@json($tipo_predio)'>
                                                                ...
                                                                <td class="edit_row">{{ $tipo_predio->codigo }}</td>

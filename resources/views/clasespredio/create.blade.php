...
@push('scripts')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\ClasesPredioCreateFormRequest', '#create-form'); !!}
    {!! JsValidator::formRequest('App\Http\Requests\ClasesPredioUpdateFormRequest', '#update-form'); !!}
                        ...
                        <div class="content-wrap">
                            <section id="section-bar-1" class="content-current">
                                <div class="panel panel-inverse">
                                    <div class="panel-heading"><i  class="{{ $opcion->icono }}"></i>&nbsp;&nbsp;Informaci&oacute;n de la clase de predio</div>
                                    <div class="panel-wrapper collapse in" aria-expanded="true">
                                        <div class="panel-body">
                                            <form action="{{ route('clasespredio.create_clasespredio') }}" method="post" id="create-form">
                                                @csrf
                                                <div class="result">
                            ...
                            <section id="section-bar-2" class="">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="well">
                                            @if(isset($clases_predio))
                                                ...
                                                <h2>Lista de clases de predio</h2>
                                                        ...
                                                        @if(count($clases_predio) > 0)
                                                            ...
                                                            <tr style="cursor: pointer;" json-data='@json($clase_predio)'>
                                                                ...
                                                                <td class="cell_center">
                                                                    <button type="button" ide="{{ $clase_predio->id }}" class="modify_row btn btn-info"><i class="fa fa-pencil-square"></i></button>
                                                                    &nbsp;&nbsp;
                                                                    <button type="button" ide="{{ $clase_predio->id }}" class="delete_row btn btn-inverse"><i class="fa fa-trash-o"></i></button>
                                                                </td>
                                                            </tr>
                                                            @endforeach
                                                        {{-- @else
                                                ...
                                                {{-- <div class="pagination-blobk">
                                                    {{ $clases_predio->links('layouts.paginationlinks') }}
                                                </div> --}}
                                                <form id="form_delete" action="{{ route('clasespredio.delete_clasespredio') }}" method="post" style="display: none;">
                                                    @csrf
                                ...
                                <div id="div_edit_form" class="panel panel-info" style="display: none;">
                                    <div class="panel-heading"><i  class="{{ $opcion->icono }}"></i>&nbsp;&nbsp;Actualizar informaci&oacute;n de la clase de predio</div>
                                    <div class="panel-wrapper collapse in" aria-expanded="true">
                                        <div class="panel-body">
                                            <form action="{{ route('clasespredio.update_clasespredio') }}" method="post" id="update-form">
                                                @csrf

            ...
            <div class="white-box">
                <section>
                    <div class="sttabs tabs-style-bar">
                        <nav>
                            <ul>
                                <li id="li-section-bar-1" class="tab-current"><a href="#section-bar-1" class="sticon ti-pulse"><span>Nueva clase de mutaci&oacute;n</span></a></li>
                                                    ...
                                                    <tbody>
                                                        @if(count($clases_mutacion) > 0)
                                                            ...
                                                            <tr style="cursor: pointer;" json-data='@json($clase_mutacion)'>
                                                                ...
                                                                <td class="edit_row cell_center">{{ $clase_mutacion->codigo }}</td>
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="control-label">C&oacute;digo</label>
                                                                <input type="text" id="codigo_edit" name="codigo_edit" class="form-control onlyNumbers" placeholder="Ingrese c&oacute;digo" value="{{ old('codigo_edit') }}" readonly="readonly">
